...
export default function Home() {
  ...
  const chatContainerRef = useRef(null); // Ref to the chat container div

  useEffect(() => {
    // Scroll to the bottom of the chat container whenever chatLog updates
  ...
  return (
    <div className="container mx-auto max-w-[700px]">
      <div className="flex flex-col h-screen bg-gray-900">
        <h3 className="bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text text-center py-3 font-bold text-6xl">
          ChatBot Madness project
        </h3>
